	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel">
				...
				<input type="text" id="fullName" name="fullName" v-model="fullName" placeholder="Nome e sobrenome">

				<label for="email">Digite seu e-mail</label>
				<input type="text" id="email" name="email" v-model="email" placeholder="Email">

				<label for="senha">Digite sua senha</label>
				<input type="password" id="fullName" name="password" v-model="password" placeholder="">
